...
export class SavePictureController {
  ...
  async handle ({ file, userId }: HttpRequest): Promise<HttpResponse<Model> | undefined> {
    ...
    if (!['image/png', 'image/jpg', 'image/jpeg'].includes(file.mimeType)) return badRequest(new InvalidMimeType(['png', 'jpeg']))
...
describe('SavePictureController', () => {
  ...
  it('Should call ChangeProfilePicture with correct input', async () => {
    ...
    expect(changeProfilePicture).toBeCalledWith({ id: userId, file: buffer })
